...
print(missedWord('assets/sample.txt'))
...
def merge(file , words):  
    ...
    return testing1
    # lst = missedWord(file)  # file is the parsed text which has text and empty{} to put things inside curly braces in te step below
...
if __name__ == "__main__":
    ...
    fileName=readFile("assets/sample.txt")
